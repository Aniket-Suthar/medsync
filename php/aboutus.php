...
<body>
    <div class="responsive-container-block outer-container">
        <div class="responsive-container-block inner-container">
            <p class="text-blk section-head-text" style="color:blue;">
                Meet Our Incredible Team
            </p>
            <p class="text-blk section-subhead-text">
                Always passionate for learning and developing
            </p>
            <div class="responsive-container-block">
                <div class="responsive-cell-block wk-desk-3 wk-ipadp-3 wk-tab-6 wk-mobile-12 team-card-container">
                    <div class="team-card">
                        <div class="img-wrapper">
                            <img class="team-img" src="../img/darshan1.jpg">
                        </div>
                        <p class="text-blk name" style="color:blue";>
                            Darshan Laljani
                        </p>
                ...
                <div class="responsive-cell-block wk-desk-3 wk-ipadp-3 wk-tab-6 wk-mobile-12 team-card-container">
                    <div class="team-card">
                        <div class="img-wrapper">
                            <img class="team-img" src="../img/aniket.jpg">
                        </div>
                        <p class="text-blk name" style="color:blue;">
                            Aniket Suthar
                        </p>
